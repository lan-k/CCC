...
tabdata <- ecmo_patients %>%
  ...
  set_variable_labels(anticoagulants = "Anticoagulant Use",
                      ...
                      day='Day put on ECMO',
                      outcome='Final outcome at hospital discharge (may be after the end of 90 day follow-up)',
                      stat = "Stroke Yes or No")
